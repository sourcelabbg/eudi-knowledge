---
name: "arf-design-guide"
description: "Use when implementing EUDI Wallet UI/UX. Covers design principles, visual identity, accessibility requirements, and user interface guidelines for Wallet Solutions."
sections:
