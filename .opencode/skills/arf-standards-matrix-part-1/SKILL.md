---
name: "arf-standards-matrix-part-1"
description: "Use when looking up which technical standards apply to EUDI ecosystem actors. Contains the matrix of essential standards mapped to CIR articles, organized by actor (Wallet Providers, Member States, Attestation Providers, Relying Parties)."
sections:
