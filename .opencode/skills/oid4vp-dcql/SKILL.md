...
credentials:
        REQUIRED. A non-empty array of Credential Queries as defined in [Section 6.1](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#credential_query)
that specify the requested Credentials.

        

credential_sets:
        OPTIONAL. A non-empty array of Credential Set Queries as defined in [Section 6.2](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#credential_set_query)
...
this object are defined per Credential Format. Examples of those are in [Appendix B.3.5](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#sd_jwt_vc_meta_parameter) and [Appendix B.2.3](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#mdocs_meta_parameter). If empty,
...
trusted_authorities:
          OPTIONAL. A non-empty array of objects as defined in [Section 6.1.1](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#dcql_trusted_authorities) that
...
claims:
          OPTIONAL. A non-empty array of objects as defined in [Section 6.3](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#claims_query) that specifies
...
The rules for selecting claims to send are defined in [Section 6.4.1](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#selecting_claims).
...
be less likely to work due to the constraints on value matching (see [Section 6.4.1](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#selecting_claims) for more details).
...
can be found in [Section 15.10](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#privacy_trusted_authorities).
...
Value:
              Contains the KeyIdentifier of the AuthorityKeyIdentifier as defined in Section 4.2.1.1 of [[RFC5280](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#RFC5280)],
...
Value:
              The identifier of a Trusted List as specified in ETSI TS 119 612 [[ETSI.TL](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#ETSI.TL)]. An ETSI
...
Value:
              The Entity Identifier as defined in Section 1 of [[OpenID.Federation](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#OpenID.Federation)] that is bound to
...
within the Credential, as defined in [Section 7](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#claims_path_pointer).
...
rules are defined in [Section 6.4.1](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#selecting_claims).
...
given in Section 6.1 of [[RFC8949](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#RFC8949)]. The resulting JSON value is then used to match against the values property as specified above.
...
(see [Section 15](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#privacy-considerations) for additional considerations). Wallets MUST NOT send
...
values defined in [Section 6.3](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#claims_query), i.e.,
...
not intended to define options the End-User can choose from, see [Section 6.4.3](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#dcql_query_ui) for
...
Additional, more complex examples can be found in [Appendix D](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#more_dcql_query_examples).
