---
name: "arf-topic-f-digital-credential-api-part-1"
description: "Use when integrating EUDI Wallet with the W3C Digital Credentials API. Covers browser integration, DC API flow, CTAP-Hybrid, and security considerations. Part 1: covers 1. Introduction, 1.3 Key words, 1.4 Document structure ...."
sections:
