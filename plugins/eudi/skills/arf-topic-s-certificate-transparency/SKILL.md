---
name: "arf-topic-s-certificate-transparency"
description: "Use when implementing or evaluating certificate transparency for the EUDI ecosystem. Covers CT logs, monitoring, and compliance requirements for access certificates."
sections:
...
| CT_06 | If an access certificate does not include a valid SCT, a Wallet Unit SHALL handle this as a failure or Relying Party authentication, in compliance with all requirements in [[Topic 6][topic-6]] and in particular requirement RPI_06a. |
