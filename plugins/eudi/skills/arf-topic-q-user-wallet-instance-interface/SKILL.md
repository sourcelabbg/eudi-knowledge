---
name: "arf-topic-q-user-wallet-instance-interface"
description: "Use when designing the user interface layer of the Wallet Instance. Covers interaction patterns, user consent flows, and accessibility requirements."
sections:
