---
name: "arf-standards-matrix-part-2"
description: "Use when looking up EUDI technical specification details. Contains the list of technical specifications referenced by the standards matrix with descriptions and status."
sections:
